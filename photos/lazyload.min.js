...
! function (a) {
  ...
  function h(a, b) {
    var e;
    return e = b._$container == d ? ("innerHeight" in c ? c.innerHeight : d.height()) + d.scrollTop() : b._$container.offset().top + b._$container.height(), e <= a.offset().top="" -="" b.threshold="" }="" function="" i(b,="" e)="" {="" var="" f;="" return="" f="e._$container" =="d" ?="" d.width()="" +="" (a.fn.scrollleft="" d.scrollleft()="" :="" c.pagexoffset)="" e._$container.offset().left="" e._$container.width(),="" <="b.offset().left" e.threshold="" j(a,="" b)="" c;="" c="b._$container" d.scrolltop()="" b._$container.offset().top,="">= a.offset().top + b.threshold + a.height()
  }
